...
let createWebringList = (matchedSiteIndices) => {
  ...
  getSites().forEach((site, index) => {
    ...
    name.className = "pr-2 py-1 font-latinRomanCaps truncate";
    ...
    year.className = "pr-2 py-1 text-left font-latinRoman";
